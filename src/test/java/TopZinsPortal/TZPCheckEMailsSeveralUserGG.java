...
public class TZPCheckEMailsSeveralUserGG {
// Die Versendung von E-Mails wird überprüft
	...
	@Test(priority = 10, dataProvider = "TZPCheckEMailsSeveralUserGG", dataProviderClass = Utils.DataSupplier.class)
	public void TZPCheckEMailSeveralUserGGTest(String Teststep, String Aktiv, String Emailadresse, String Passwort,
			String Betreff, String Anhang, String Link1, String Link2, String Registrierung) throws Exception {

		// Beachte, Nach dem Einlesen der Mails werden diese als "Gelesen" markiert und
		// beim nächsten Durchlauf nicht mehr eingelesen
		...
		if (Aktiv.equals("Ja")) {
			...
			ExtentTest test = extent.createTest("TZPCheckEMailSeveralUserGG: " + Teststep + " - " + AblaufartGlobal,
					"Kontrolle von E-Mails an Geldgebern (GG) als Company User");
			...
			softassert.assertTrue(
					Utils.EMailUtils.EmailPruefen(Mailweitergabe, Betreff, Anhang, Link1, Link2, Registrierung, test));
			softassert.assertAll(); // Damit der Code weiter durchlaufen wird.
