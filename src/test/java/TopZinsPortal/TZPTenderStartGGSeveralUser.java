...
public class TZPTenderStartGGSeveralUser {
	...
	public Eyes eyes = null;
		...
		// @Test
		@Test(dataProvider = "TZPTenderStartGGSeveralUser", dataProviderClass = Utils.DataSupplier.class)
		public void TZPTenderStartGGSeveralUserTest(String Teststep, String Aktiv, String EmailadresseGG, String PasswortGG, String EndeDatum, 
