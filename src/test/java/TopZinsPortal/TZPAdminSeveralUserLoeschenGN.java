...
public class TZPAdminSeveralUserLoeschenGN {
	...
	public void TZPAdminSeveralUserLoeschenGNTest(String Teststep, String Aktiv, String Menue,
		...
		if (Aktiv.equals("Ja")) {
			...
			ExtentTest test = extent.createTest("TZPAdmin" + "Löschen: " + Teststep + " - " + AblaufartGlobal,
					"Löschen eines Several-User-Anwenders");
