...
public class TZPAdminHandelsfreigabeGN {
	...
	public void SetupSeleniumTestdaten(@Optional("Ad Hoc Test") String Ablaufart) throws InterruptedException, IOException {
		...
		if (htmlReporter == null) {
			// start reporters
			htmlReporter = new ExtentHtmlReporter("Fehlerreport TopZinsPortal Admin HandelsfreigabeGN - " + Ablaufart + ".html");
	...
	public void TZPAdminHandelsfreigabeGNTest(String Teststep, String Aktiv, String Emailadresse, String Passwort, String Menue, String ZeilenProSeite, String Unternehmensname) throws Exception {
		...
		Thread.sleep(3 * Zeitspanne);
		Utils.SeleniumUtils.FullPageScreenshotAShotSelenium(driver, Zeitspanne, projectpath, "\\Admin Handelsfreigabe\\AmdinHandlefreigabe-GN-Auswahl", Teststep, test);
		Thread.sleep(3 * Zeitspanne);
		...
		// Screenshot aufnehmen
		Thread.sleep(3 * Zeitspanne);
		Utils.SeleniumUtils.FullPageScreenshotAShotSelenium(driver, Zeitspanne, projectpath, "\\Admin Handelsfreigabe\\AmdinHandlefreigabe-GN-Haken", Teststep, test);
