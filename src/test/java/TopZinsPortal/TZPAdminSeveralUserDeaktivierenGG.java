...
public class TZPAdminSeveralUserDeaktivierenGG {
	...
	public void TZPAdminSeveralUserDeaktivierenGGTest(String Teststep, String Aktiv, String Menue,
		...
		if (Aktiv.equals("Ja")) {
			...
			if (Handel) {
				...
				if (Menue.equals("EINGELADEN")) {
					xpathvalue = "//div[text() = '" + EmailadresseCompanyUser
							+ "']//ancestor::tr[contains(@class, 'MuiTableRow-root')]//button";
				} else {
				
				xpathvalue = "//div[text() = '" + EmailadresseCompanyUser
						+ "']//ancestor::tr[contains(@class, 'MuiTableRow-root')]//button[contains(@class, 'jss')]";
				}
