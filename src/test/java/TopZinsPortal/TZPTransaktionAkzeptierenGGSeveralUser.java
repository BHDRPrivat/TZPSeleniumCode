...
public class TZPTransaktionAkzeptierenGGSeveralUser {
	...
	public Eyes eyes = null;
		...
		// @Test
		@Test(dataProvider = "TZPTransaktionAkzeptierenGGSeveralUser", dataProviderClass = Utils.DataSupplier.class)
		public void TZPTransaktionAkzeptierenGGSeveralUserTest(String Teststep, String Aktiv, String EmailadresseGG, String PasswortGG, String VolumenGG, 
