...
public class TZPTransaktionBearbeitenGNSeveralUser {
...
//		System.out.println("Zeile=" + rowCount + "Spalte=" + colCount + "String Wert: ");
	...
	// @Test
	@Test(priority = 0, dataProvider = "TZPTransaktionBearbeitenGNSeveralUser", dataProviderClass = Utils.DataSupplier.class)
	public void TZPTransaktionBearbeitenGNSeveralUserTest(String Teststep, String Aktiv, String EmailadresseGG, String PasswortGG,
		...
		if (Aktiv.equals("Ja")) {
			...
			if (BtnAngebotSendenGN.equals("Ja")) {
				...
				Thread.sleep(3 * Zeitspanne);
				// Sichtbarkeit des Buttons als Bedingung für den erfolgreichen Durchlauf
				...
				// Es gibt schon eine Prüfung über Variablen
...
//			System.out.println("GN logout");
	...
	@Test(priority=10)
	public void TZPTransaktionAkzeptierenGNSeveralUserTest() {
	...
	@Test(priority=20)
	public void TZPTransaktionAblehnenGNSeveralUserTest() {
	// Softassert-Kontrolle durchfühern
	SoftAssert softassert = new SoftAssert();
	// Variable Login gibt an, welches Ergebnis vorliegt.
	...
	@Test(priority=30)
	public void TZPTransaktionTelefonischWeiterleitenGNSeveralUserTest() {
	// Softassert-Kontrolle durchfühern
	SoftAssert softassert = new SoftAssert();
	// Variable Login gibt an, welches Ergebnis vorliegt.
