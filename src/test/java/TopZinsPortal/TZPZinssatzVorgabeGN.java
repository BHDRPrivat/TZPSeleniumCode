...
public class TZPZinssatzVorgabeGN {
	...
	public void SetupSeleniumTestdaten(@Optional("Ad Hoc Test") String Ablaufart)
		...
		if (htmlReporter == null) {
			...
			htmlReporter = new ExtentHtmlReporter(
					"Fehlerreport TopZinsPortal Zinseingabe Start GN - " + Ablaufart + ".html");
	...
	public void TZPZinssatzVorgabeGNTest(String Teststep, String Aktiv, String Unternehmensname, String Emailadresse,
		...
		if (Aktiv.equals("Ja")) {
			...
			Utils.SeleniumUtils.ButtonKlick(driver, Zeitspanne, "xpath",
					"//span[text()='Aktualisieren']//ancestor::button", test);
			Thread.sleep(3 * Zeitspanne);
			...
			Utils.SeleniumUtils.ButtonKlick(driver, Zeitspanne, "xpath",
					"//span[text()='Veröffentlichen']//ancestor::button", test);
