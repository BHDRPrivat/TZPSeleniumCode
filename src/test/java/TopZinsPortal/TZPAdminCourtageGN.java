...
public class TZPAdminCourtageGN {
	...
	public void SetupSeleniumTestdaten(@Optional("Ad Hoc Test") String Ablaufart)
		...
		if (htmlReporter == null) {
			...
			htmlReporter = new ExtentHtmlReporter(
					"Fehlerreport TopZinsPortal Admin Courtage - " + Ablaufart + ".html");
			// create ExtentReports and attach reporter(s)
			extent = new ExtentReports();
			extent.attachReporter(htmlReporter);
		}

		System.out.println("Admin setzt courtage: " + Ablaufart);
	...
	// @Test
	@Test(dataProvider = "TZPAdminCourtageGN", dataProviderClass = Utils.DataSupplier.class)
	public void TZPAdminUserDeaktivierenGNTest(String Teststep, String Aktiv, String FirmaGN, String CourtageBP) throws Exception {

		if (Aktiv.equals("Ja")) {

			// creates a toggle for the given test, adds all log events under it
			ExtentTest test = extent.createTest("TZPAdmin" + "deaktivieren: " + Teststep + " - " + AblaufartGlobal,
					"Courtage Eingabe durch den Forsa-Admin");
			...
			if (Handel) {
				...
				// 3. "Mit Handelsberechtigung" in Menue auswaehlen
				Utils.SeleniumUtils.ButtonKlick(driver, Zeitspanne, "xpath", "//li[@data-test='MIT HANDELSBERECHTIGUNG']", test);
				...
				Utils.SeleniumUtils.InputText(driver, Zeitspanne, "name", "search", FirmaGN, test);
