...
public class TZPTenderAngebotSendenGNSeveralUser {
	...
	public Eyes eyes = null;
		...
		// @Test
		@Test(dataProvider = "TZPTenderAngebotSendenGNSeveralUser", dataProviderClass = Utils.DataSupplier.class)
		public void TZPTenderAngebotSendenGNSeveralUserTest(String Teststep, String Aktiv, String EmailadresseGG, String PasswortGG, String EndeDatum, 
