...
public class TZPAdminUserLoeschenGG {
	...
	// Hier belassen, da duruch Fallunterscheidung die richtigen Daten ausgelesen
	// werden
	@DataProvider(name = "TZPAdminLoeschenGG")
	...
	// @Test
	@Test(dataProvider = "TZPAdminLoeschenGG")
	public void TZPAdminUserLoeschenGGTest(String Teststep, String Aktiv, String Menue, String ZeilenProSeite,
