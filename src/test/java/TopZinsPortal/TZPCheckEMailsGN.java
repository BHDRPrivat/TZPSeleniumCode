...
// Die Versendung von E-Mails wird überprüft
	...
	public void SetupSeleniumTestdaten(@Optional("Ad Hoc Test") String Ablaufart)
		...
		if (htmlReporter == null) {
			...
			htmlReporter = new ExtentHtmlReporter(
					"Fehlerreport TopZinsPortal E-Mail Versendung GN - " + Ablaufart + ".html");
	...
	@Test(priority = 10, dataProvider = "TZPCheckEMailsGN", dataProviderClass = Utils.DataSupplier.class)
	
	public void TZPCheckEMailsGNTest(String Teststep, String Aktiv, String Emailadresse, String Passwort, String Betreff,
		...
		if (Aktiv.equals("Ja")) {
			...
			ExtentTest test = extent.createTest("TZPCheckEMailGN: " + Teststep + " - " + AblaufartGlobal,
					"Kontrolle von E-Mails an Geldnehmern (GN)");
