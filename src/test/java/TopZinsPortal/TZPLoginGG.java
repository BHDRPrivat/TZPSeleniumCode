	...
	public Eyes eyes = null;
		...
		public void SetupSeleniumTestdaten(@Optional("Ad Hoc Test") String Ablaufart) throws InterruptedException, IOException {
			...
			if (htmlReporter == null) {
				// start reporters
				htmlReporter = new ExtentHtmlReporter("Fehlerreport TopZinsPortal Login GG - " + Ablaufart + ".html");
		...
		public void TZPLoginGGTest(String Teststep, String Aktiv, String Emailadresse, String Passwort, String Unternehmensname, String Kundengruppe, String LEI,
			...
			ExtentTest test = extent.createTest("TZPLoginGG: " + Teststep + " - " + AblaufartGlobal,
			...
			Thread.sleep(3 * Zeitspanne);
			Utils.SeleniumUtils.FullPageScreenshotAShotSelenium(driver, Zeitspanne, projectpath, "\\Reg GG\\Login-GG-Eingabe", Teststep, test);
			Thread.sleep(3 * Zeitspanne);
			...
			// Screenshot aufnehmen
			Thread.sleep(3 * Zeitspanne);
			Utils.SeleniumUtils.FullPageScreenshotAShotSelenium(driver, Zeitspanne, projectpath, "\\Reg GG\\Login-GG-Register", Teststep, test);
			Thread.sleep(3 * Zeitspanne);	
