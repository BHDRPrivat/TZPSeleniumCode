...
public class TopZinsPortalRegistrierungGG {
	...
	public void Setup() throws InterruptedException, IOException {
		...
		if (htmlReporter == null) {
			// start reporters
			htmlReporter = new ExtentHtmlReporter("Fehlerreport TopZinsPortal Registrierung Geldgeber: " + Ablaufart + ".html");
		...
		BaseUrl = "http://52.59.225.49/portal/registrierungGeldgeber";
		SpeicherpfadTestdokumente = "F:\\BHDR\\Test-PDF-Dokumente\\";
	...
	public static Object[][] getData() throws BiffException {
		...
		TestdatenExceldatei = "\\Excel\\AL-Risiko-Testdaten-V1.xls";
