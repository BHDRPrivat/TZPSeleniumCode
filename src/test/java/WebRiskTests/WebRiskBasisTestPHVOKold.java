...
public class WebRiskBasisTestPHVOKold {
	...
	public void ApplitoolsAufnahme(String teststep) {
		if (ApplitoolsAufnahme.equals("true")) {
			// Applitools vorbereiten

			// Vor dem Definieren der Driver setzen
			eyes = new Eyes();
	...
	public void ScreenshotAufnahme(ChromeDevToolsService devToolsService, String bildPath) throws InterruptedException {
		if (ScreenshotAufnehmen.equals("true")) {
			// Screenshot erzeugen;
	...
	public void BasisRisiko(@Optional("Default") String Ablaufart, String teststep, String geburtsdatum,
			String familienstatus, String deckungssumme, String zahlweise, String xxlBeitrag)
		...
		// Take full screen
		ScreenshotAufnahme(devToolsService, "D:\\IR-WebRisk-Testdaten\\PHV\\" + teststep + "-Eingabemaske.png");
		...
		Thread.sleep(3 * Zeitspanne);
		// Screenshot erzeugen;
		ScreenshotAufnahme(devToolsService, "D:\\IR-WebRisk-Testdaten\\PHV\\" + teststep + "-Ergebnismaske.png");
		Thread.sleep(2 * Zeitspanne);

		// Aufnahme für Applitool
		ApplitoolsAufnahme(teststep);
		Thread.sleep(2 * Zeitspanne);
		...
		// Screenshot erzeugen;
		ScreenshotAufnahme(devToolsService, "D:\\IR-WebRisk-Testdaten\\PHV\\" + teststep + "-Warenkorb.png");

		if (Druckauswahl.equals("true")) {
			// Druckauswahl
		...
		// Scrennshot
		ScreenshotAufnahme(devToolsService, "D:\\IR-WebRisk-Testdaten\\PHV\\" + teststep + "-Druckauswahl.png");
