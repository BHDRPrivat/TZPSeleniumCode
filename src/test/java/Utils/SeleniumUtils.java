...
public class SeleniumUtils {
	...
	public static void HakenKlick(WebDriver driver, Integer Zeitspanne, String HTMLSelector, String ObjektPath) throws InterruptedException {
		// Mit Try, Catch den Weiterlauf nach einem Fehler ermöglichen  
		try {
		if ( !driver.findElement(By.xpath(ObjektPath)).isSelected()){
			Utils.SeleniumUtils.ButtonKlick(driver, Zeitspanne, "xpath", ObjektPath);	
		}
		} catch (NoSuchElementException e) {
			// Fehlerbehandlung einfügen
			System.out.println("Gemeldeter Fehler: " + e);
